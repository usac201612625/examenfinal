...
''' #GDTA configuración de cliente mqtt
servidor = mqtt.Client(clean_session=True)
servidor.connect(host = MQTT_HOST, port = MQTT_PORT)
servidor.on_connect = con_connect '''
